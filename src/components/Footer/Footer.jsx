...
function Footer() {
    return (
        <>
            ...
            <div id="footer" className='d-flex justify-content-center align-item-center p-4'>
                <div>
                    ...
                    <div className='cursor-pointer'>
                        <Nav defaultActiveKey="/" as="ul">
                            ...
                            <Nav.Item as="li">
                                <Nav.Link as={Link} to="/policy" className='text-light'>Privacy Policy</Nav.Link>
                            </Nav.Item>
                            <Nav.Item as="li">
                                <Nav.Link as={Link} to="/terms" className='text-light'>Terms of Service</Nav.Link>
                            </Nav.Item>
                        </Nav>
                        {/* features 1.Interactive Exercises 2.Expert Assistance 3.Track Your Progress */}
                    </div>
                    <div className='d-flex  justift-content-center cursor-pointer'>
                        <div className="card ">
                        ...
                        <div className="card">
                            ...
                            <a href="#" className="socialContainer containerTwo d-flex">
                    ...
                    <div className='cursor-pointer'> <span className='text-light p-1'>Email : </span><span className='text-primary'>workflowhub@gmail.com</span></div>
                    <div className='cursor-pointer'> <span className='text-light p-1'>Phone : </span><span>+1 234 567 890</span></div>
